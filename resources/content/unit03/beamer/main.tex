...
\begin{frame}
 ...
 $$\ce{^{7}_{3}Li}$$
    ...
    \begin{tikzpicture}
        ...
        \onslide<5->\draw (center) circle[radius=\radius];
        \onslide<6-> \fill[black] (center) ++(135:\radius) circle[radius=2pt]  node[above left] {e-};
        \onslide<7-> \fill[black] (center) ++(-45:\radius) circle[radius=2pt] node[below right] {e-};
        \onslide<8->\draw (center) circle[radius=\radius*1.5];
        \onslide<9->\fill[black] (center) ++(0:\radius*1.5) circle[radius=2pt] node[below right] {e-};
